...
#define LAYOUT_QWERTY "qwertyuiopasdfghjkl;zxcvbnm,./"
#define LAYOUT_COLEMAK "qwfpbjluy;arstgmneiozxcdvkh,./"
#define LAYOUT_NYMPH "xympbjwouqnhstg:reiavfcdkzl',."
#define LAYOUT_CANARY "wlypbzfou'crstgmneiaqjvdkxh/,."
#define LAYOUT_MTGAP "ypoujkdlcwinea,mhtsrqz/.:bfgvx"
...
#define ALGORITHM_ROUNDS 32                     /* recommended 8-32 */
#define RUNS_BEFORE_PURGE 5
#define CHANCE_TO_USE_PREVIOUS_LAYOUT 0.2       /* recommended 0.2 */
#define CHANCE_EXPONENTIATOR 0.9                /* recommended 0.7-1 */
#define RUNS_BEFORE_CHANCE_INC 5                /* recommended 1 */
...
#define PLAUSIBLE_HOMEROW_THRESHOLD 16
...
int64_t handTravelCosts[KSIZE_MAX];

double fingerPercentMaxes[FINGER_COUNT];
int fingerTravelMaxPercent[FINGER_COUNT];
...
char *textLayout, *symbolLayout, *shiftLayout;
double sameFingerMax;

int keepZXCV, keepQWERTY, keepNumbers, keepBrackets, keepShiftPairs, 
	keepTab, keepConsonantsLeft, keepAlphas, noHomeRowC, keepHomeRowLeft, keepHomeRowRight,
	doSymbolLayer, keepNumbersShifted /* for bogboar */;
int zCost, xCost, cCost, vCost, qwertyPosCost, qwertyFingerCost, qwertyHandCost, 
	numbersShiftedCost, similarSymbolsMath, similarSymbolsLogic, sameHandsBrackets, mixedLayersCost,
	shiftCostMono, symbolCostMono;

int64_t bracketsCost, adHoc;

int distance, overallScale, inRoll, outRoll, sameHand, sameFingerP, sameFingerR, sameFingerM, 
	sameFingerI, sameFingerT, rowChangeDown, rowChangeUp, handWarp, handSmooth, handMove,
	homeJump, homeJumpIndex, doubleJump, ringJump, toCenter, biLayerSplit,
	shiftCost, doubleShiftCost, pinkyOverload, ringOverload, indexCorner, 
	lateralStretch, halfScissor, fullScissor, symbolCost, doubleSymbolCost, preferAlternation,
	includeCodeData, preferTrigramRolls, forceBracketsHomeRow, treatAnglesAsBrackets,
	includeSymbolRolls, layerDiffBi, travelCost, sfbAboveMaxPenalty, flexibleSymbolLocations,
	ignoreWorkForRareSymbols, forceMirrorOrSameHand, forceBracketMirrors, aestheticDifferenceThreshold,
	useRingForTopPinky;

int	triSplitFinger,	triInRoll,	triOutRoll,	triOneHand,	triAlt,	triRedirect,
	halfScissorTri, fullScissorTri, lateralStretchTri, triHomeJump;

double aestheticsMinor, aestheticsMajor;
